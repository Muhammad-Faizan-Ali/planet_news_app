class SearchNewsModel {
  ...
  late final List<SearchNewsList> data;

  SearchNewsModel.fromJson(Map<String, dynamic> json){
    data = List.from(json['data']).map((e)=>SearchNewsList.fromJson(e)).toList();
  }
...
class SearchNewsList {
  ...
  SearchNewsList.fromJson(Map<String, dynamic> json){
    id = json['id'];
    catId = json['cat_id'];
